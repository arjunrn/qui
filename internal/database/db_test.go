...
var expectedSchema = map[string][]columnSpec{
	...
	"theme_effects_preferences": {
		{Name: "id", Type: "INTEGER", PrimaryKey: true},
		{Name: "user_id", Type: "INTEGER"},
		{Name: "theme_scope", Type: "TEXT"},
		{Name: "created_at", Type: "TIMESTAMP"},
		{Name: "updated_at", Type: "TIMESTAMP"},
	},
	"theme_effects_settings": {
		{Name: "id", Type: "INTEGER", PrimaryKey: true},
		{Name: "user_id", Type: "INTEGER"},
		{Name: "theme_key", Type: "TEXT"},
		{Name: "background_scope", Type: "TEXT"},
		{Name: "mode_scope", Type: "TEXT"},
		{Name: "particles_mode", Type: "TEXT"},
		{Name: "background_position", Type: "TEXT"},
		{Name: "background_opacity", Type: "INTEGER"},
		{Name: "overlay_strength", Type: "INTEGER"},
		{Name: "mobile_background", Type: "TEXT"},
		{Name: "created_at", Type: "TIMESTAMP"},
		{Name: "updated_at", Type: "TIMESTAMP"},
	},
	"theme_effects_backgrounds": {
		{Name: "id", Type: "INTEGER", PrimaryKey: true},
		{Name: "user_id", Type: "INTEGER"},
		{Name: "theme_key", Type: "TEXT"},
		{Name: "slot", Type: "TEXT"},
